 ...
 */
#define OUTPUT_PROC_NR	TTY_PROC_NR	/* TODO TTY_PROC_NR or LOG_PROC_NR */

/* NR_CONS, NR_RS_LINES, and NR_PTYS determine the number of terminals the
 * system can handle.
 */
#define NR_CONS			4	/* # system consoles (1 to 8) */
#define NR_RS_LINES		0	/* TODO # rs232 terminals (0 to 4) */
#define NR_PTYS			0	/* TODO # pseudo terminals (0 to 64) */
